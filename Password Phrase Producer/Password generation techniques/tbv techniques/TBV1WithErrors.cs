...
namespace Password_Phrase_Producer.Password_generation_techniques.tbv_techniques
{
    internal class TBV1WithErrors
    {
        ...
        public string Encrypt(string input, int multiplier, int subtractor, int adder)
        {
